...

//FUNCTION dlt2(VecA REF AS Vec2, VecB REF AS Vec2) // "Delta"    Vector from 'VecA' to 'VecB'
//    Result AS Vec2
...
ENDFUNCTION VecA.x*VecB.x + VecA.y*VecB.y         //    How much does B overlap with A.  ~ish


///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
FUNCTION crs2(VecA REF AS Vec2, VecB REF AS Vec2) // 'VecA' "cross" 'VecB'
ENDFUNCTION VecA.x*VecB.y - VecA.y*VecB.x         //    How much does B 'cross' with A.  ~ish



FUNCTION inv2(VecA REF AS Vec2) // "Inverse"    Additive-Inverse of 'VecA'.
    Result AS Vec2
    Result.x = -VecA.x
    Result.y = -VecA.y
ENDFUNCTION Result
...

FUNCTION rotl2(VecA REF AS Vec2) // "Rotate Left" Rotate 90 degrees Anti-Clockwise.
    Result AS Vec2
    Result.x = -VecA.y
    Result.y =  VecA.x
ENDFUNCTION Result
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
FUNCTION rotr2(VecA REF AS Vec2) // "Rotate Right" Rotate 90 degrees Clockwise.
    Result AS Vec2
    Result.x =  VecA.y
    Result.y = -VecA.x
ENDFUNCTION Result
...
FUNCTION rot2p(Point REF AS Vec2, Pivot REF AS Vec2, Theta AS FLOAT) // "Rotate" 'Point' around 'Pivot'.
    ...
    DltX AS FLOAT : DltX = Point.x - Pivot.x
    DltY AS FLOAT : DltY = Point.y - Pivot.y
